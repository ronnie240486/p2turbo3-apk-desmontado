...
public abstract class a {
    ...
    public static String b(byte[] bArr, int i, int i5) {
        ...
        int i9 = 0;
        while (i6 < i + i5) {
            char cCharAt = f1000g[i8].charAt(bArr[i6]);
            switch (cCharAt) {
                case 65520:
                case 65521:
                case 65522:
                ...
                default:
                    ...
                    break;
                case 65531:
                    int i10 = (bArr[i6 + 1] << 24) + (bArr[i6 + 2] << 18) + (bArr[i6 + 3] << 12) + (bArr[i6 + 4] << 6);
                    i6 += 5;
                    sb.append(new DecimalFormat("000000000").format(i10 + bArr[i6]));
                    break;
            }
            int i11 = i7 - 1;
            if (i7 == 0) {
