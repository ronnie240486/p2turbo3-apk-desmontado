    ...
    LONG_OR_DOUBLE { // from class: com.google.gson.ToNumberPolicy.3
        private Number parseAsDouble(String str, JsonReader jsonReader) throws MalformedJsonException {
            try {
                ...
                throw new JsonParseException("Cannot parse " + str + "; at path " + jsonReader.getPreviousPath(), e6);
            }
        }
    ...
    BIG_DECIMAL { // from class: com.google.gson.ToNumberPolicy.4
        ...
        public BigDecimal readNumber(JsonReader jsonReader) throws IOException {
            ...
            try {
                ...
                throw new JsonParseException("Cannot parse " + strNextString + "; at path " + jsonReader.getPreviousPath(), e6);
            }
        }
    }
}
