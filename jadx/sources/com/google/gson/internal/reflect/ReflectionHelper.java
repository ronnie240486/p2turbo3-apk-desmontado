...
public class ReflectionHelper {
    ...
    public static void makeAccessible(AccessibleObject accessibleObject) {
        try {
            ...
            throw new JsonIOException("Failed making " + getAccessibleObjectDescription(accessibleObject, false) + " accessible; either increase its visibility or write a custom TypeAdapter for its declaring type." + getInaccessibleTroubleshootingSuffix(e6), e6);
        }
    }
