...
public final class MovieCategoryDao_Impl implements MovieCategoryDao {
    ...
    public MovieCategoryDao_Impl(p pVar) {
        this.__db = pVar;
        this.__insertionAdapterOfItemCat = new e(pVar) { // from class: com.legacy.prime.BancoSql.movies.MovieCategoryDao_Impl.1
        ...
        this.__preparedStmtOfLimpar = new u(pVar) { // from class: com.legacy.prime.BancoSql.movies.MovieCategoryDao_Impl.2
            @Override // androidx.room.u
            public String createQuery() {
    ...
    @Override // com.legacy.prime.BancoSql.movies.MovieCategoryDao
    public List<a> getCategoriasAdultos() {
        s sVarO = s.o(0, "SELECT * FROM cat WHERE LOWER(name) LIKE '%adult%' OR LOWER(name) LIKE '%+18%'");
        this.__db.assertNotSuspendingTransaction();
        Cursor cursorG = p061k4.a.G(this.__db, sVarO);
        try {
    ...
    @Override // com.legacy.prime.BancoSql.movies.MovieCategoryDao
    public List<a> getCategoriasInfantis() {
        s sVarO = s.o(0, "SELECT * FROM cat WHERE LOWER(name) LIKE '%kid%' OR LOWER(name) LIKE '%infan%' OR LOWER(name) LIKE '%anima%' OR LOWER(name) LIKE '%desen%'");
        this.__db.assertNotSuspendingTransaction();
        Cursor cursorG = p061k4.a.G(this.__db, sVarO);
        try {
            int iM = p055j4.a.m(cursorG, "id");
