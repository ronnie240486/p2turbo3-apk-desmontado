...
public final class CipherSuite {
        ...
        ORDER_BY_NAME = new Comparator<String>() { // from class: okhttp3.CipherSuite$Companion$ORDER_BY_NAME$1
            ...
            public int compare(String str, String str2) {
                ...
                for (int i = 4; i < iMin; i++) {
                    ...
                    if (cCharAt != cCharAt2) {
                        return e.h(cCharAt, cCharAt2) < 0 ? -1 : 1;
                    }
                }
    ...
    public /* synthetic */ CipherSuite(String str, c cVar) {
        this(str);
    }
    ...
    public final String m31deprecated_javaName() {
