...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    public static final class Builder {
        ...
        public final Builder m115addInterceptor(final l lVar) {
            e.f(lVar, "block");
        ...
        public final Builder m116addNetworkInterceptor(final l lVar) {
            e.f(lVar, "block");
        ...
        public final Builder authenticator(Authenticator authenticator) {
            e.f(authenticator, "authenticator");
            this.authenticator = authenticator;
            return this;
        }
        ...
        public final Builder certificatePinner(CertificatePinner certificatePinner) {
            e.f(certificatePinner, "certificatePinner");
        ...
        public final Builder eventListenerFactory(EventListener.Factory factory) {
            e.f(factory, "eventListenerFactory");
        ...
        public final Builder hostnameVerifier(HostnameVerifier hostnameVerifier) {
            e.f(hostnameVerifier, "hostnameVerifier");
        ...
        public final Builder minWebSocketMessageToCompress(long j5) {
            if (j5 < 0) {
                throw new IllegalArgumentException(i.d("minWebSocketMessageToCompress must be positive: ", j5).toString());
            }
        ...
        public final Builder protocols(List<? extends Protocol> list) {
            e.f(list, "protocols");
            ArrayList arrayListD0 = k.d0(list);
            ...
            e.e(listUnmodifiableList, "unmodifiableList(protocolsCopy)");
            this.protocols = listUnmodifiableList;
            return this;
        }

        public final Builder proxy(Proxy proxy) {
            if (!e.a(proxy, this.proxy)) {
                this.routeDatabase = null;
            }
            this.proxy = proxy;
            return this;
        ...
        public Builder(OkHttpClient okHttpClient) {
            ...
            q.U(this.interceptors, okHttpClient.interceptors());
            q.U(this.networkInterceptors, okHttpClient.networkInterceptors());
            ...
            while (it.hasNext()) {
                if (((ConnectionSpec) it.next()).isTls()) {
                    if (builder.getSslSocketFactoryOrNull$okhttp() != null) {
                        ...
                        e.c(x509TrustManagerOrNull$okhttp);
                        ...
                        Platform platform = companion.get();
                        e.c(x509TrustManagerPlatformTrustManager);
    ...
    private final void verifyClientState() {
        ...
        e.d(list, "null cannot be cast to non-null type kotlin.collections.List<okhttp3.Interceptor?>");
        if (list.contains(null)) {
            throw new IllegalStateException(("Null interceptor: " + this.interceptors).toString());
        }
        List<Interceptor> list2 = this.networkInterceptors;
        e.d(list2, "null cannot be cast to non-null type kotlin.collections.List<okhttp3.Interceptor?>");
