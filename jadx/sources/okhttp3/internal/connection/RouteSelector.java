...
public final class RouteSelector {
    ...
    public static final class Companion {
        ...
        public final String getSocketHost(InetSocketAddress inetSocketAddress) {
            ...
            e.e(hostAddress, "address.hostAddress");
            return hostAddress;
        }
    ...
    public RouteSelector(Address address, RouteDatabase routeDatabase, Call call, EventListener eventListener) {
        e.f(address, "address");
        e.f(routeDatabase, "routeDatabase");
        e.f(call, "call");
    ...
    private final void resetNextInetSocketAddress(Proxy proxy) throws SocketException, UnknownHostException {
        ...
        if (Util.canParseAsIpAddress(strHost)) {
            listLookup = f.J(InetAddress.getByName(strHost));
        } else {
    ...
    public final Selection next() {
        ...
        if (arrayList.isEmpty()) {
            q.U(arrayList, this.postponedRoutes);
