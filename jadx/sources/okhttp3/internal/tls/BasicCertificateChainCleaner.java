...
public final class BasicCertificateChainCleaner extends CertificateChainCleaner {
    ...
    public BasicCertificateChainCleaner(TrustRootIndex trustRootIndex) {
        e.f(trustRootIndex, "trustRootIndex");
    ...
    public List<Certificate> clean(List<? extends Certificate> list, String str) throws SSLPeerUnverifiedException {
        ...
        e.e(objRemoveFirst, "queue.removeFirst()");
        ...
        for (int i = 0; i < 9; i++) {
            ...
            if (x509CertificateFindByIssuerAndSignature != null) {
                ...
                do {
                    ...
                    Object next = it.next();
                    e.d(next, "null cannot be cast to non-null type java.security.cert.X509Certificate");
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof BasicCertificateChainCleaner) && e.a(((BasicCertificateChainCleaner) obj).trustRootIndex, this.trustRootIndex);
    }
