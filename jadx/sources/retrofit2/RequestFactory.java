...
final class RequestFactory {
    ...
    public static final class Builder {
        ...
        @Nullable
        private ParameterHandler<?> parseParameter(int i, Type type, @Nullable Annotation[] annotationArr, boolean z5) {
            ...
            if (z5) {
                try {
                    if (Utils.getRawType(type) == b.class) {
        ...
        private ParameterHandler<?> parseParameterAnnotation(int i, Type type, Annotation[] annotationArr, Annotation annotation) {
            ...
            if (annotation instanceof Part) {
                ...
                Headers headersOf = Headers.of("Content-Disposition", d.k("form-data; name=\"", strValue5, "\""), "Content-Transfer-Encoding", part.encoding());
                if (!Iterable.class.isAssignableFrom(rawType8)) {
                    if (!rawType8.isArray()) {
                        if (MultipartBody.Part.class.isAssignableFrom(rawType8)) {
            ...
            if (annotation instanceof Body) {
                ...
                try {
                    ...
                    throw Utils.parameterError(this.method, e6, i, "Unable to create @Body converter for %s", type);
                }
            }
            ...
            for (int i5 = i - 1; i5 >= 0; i5--) {
                ...
                if ((parameterHandler instanceof ParameterHandler.Tag) && ((ParameterHandler.Tag) parameterHandler).cls.equals(rawType10)) {
                    throw Utils.parameterError(this.method, i, "@Tag type " + rawType10.getName() + " is duplicate of parameter #" + (i5 + 1) + " and would always overwrite its value.", new Object[0]);
                }
            }
        ...
        public RequestFactory build() {
            ...
            while (true) {
                ...
                parameterHandlerArr[i5] = parseParameter(i5, type, annotationArr, z5);
                i5++;
            }
